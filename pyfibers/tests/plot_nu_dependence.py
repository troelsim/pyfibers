...
for nu in range(-2,3):
    ...
    plt.plot(radii, np.real(mode.e_r(mode, radii, 0, 0)), '', label="nu=%d, real part" % nu)
    plt.plot(radii, np.imag(mode.e_r(mode, radii, 0, 0)), '', label="nu=%d, real part" % nu)
